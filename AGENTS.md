...
Read DEVELOPMENT_PRINCIPLES.md (shared rule version 2026-09-13.2), CONTRIBUTING.md and CODEX_CLOUD.md before development. These are the shared Chembridge defaults plus this product's account, source and verification constraints. New user instructions take precedence.
