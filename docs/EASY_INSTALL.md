# Easy installation — 0.7.0 student preview

## Windows x64

Download the Windows setup ZIP from the [0.7.0 release](https://github.com/saigyujikingyo-png/edinburgh-study-agent/releases/tag/v0.7.0), extract the whole archive, and double-click **Install.cmd**. Keep the `payload` folder beside it.
...
- A second student's own account and real 0.7.0 model conversations across all hosts have not been certified.
